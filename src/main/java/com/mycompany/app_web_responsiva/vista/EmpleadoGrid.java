...
public class EmpleadoGrid extends Window{
    ...
    private Grid<Empleado> resultados;
    ...
    private void init(){
        ...
        botonAgregar = new Button("Agregar");
            ...
            botonAgregar.addClickListener(event -> {mainUI.addWindow(new EmpleadoEntradaWin());});
        ...
        resultados = new Grid<>();
            ...
            resultados.addColumn(Empleado::getId).setCaption("Id");
            resultados.addColumn(Empleado::getClave).setCaption("Clave");
            resultados.addColumn(Empleado::getFecha).setCaption("Fecha y hora de entrada");
        ...
        setCaption("<h3><center>Listado de Entradas</center></h3>");
            
    }
    
    
    private Button crearBotonEditar(Empleado obj){
        Button boton = new Button();
            ...
            boton.addClickListener(event -> {
                mainUI.addWindow(new EmpleadoEntradaWin(obj.getId()));
            });
        return boton;
    }
    ...
    private void eventoBotonBuscar(){
        try{
            List<Empleado> lista = mainUI
                .getControladorEmpleado()
                    .getRepositorioEmpleado()
