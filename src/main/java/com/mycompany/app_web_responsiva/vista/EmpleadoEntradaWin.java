...
public class EmpleadoEntradaWin extends Window{
    ...
    public EmpleadoEntradaWin(){
        init();
    }
    
    public EmpleadoEntradaWin(long idObj){
        init();
        loadData(idObj);
    }
    ...
    private void init(){
        ...
        setCaption("<h3></center>Datos de entrada</center></h3>");
        center();
    ...
    private void loadData(long idObj){
        try{
            Empleado obj = mainUI.getControladorEmpleado()
                    .getRepositorioEmpleado().getOne(idObj);
            id = obj.getId();
    ...
    private void eventoBotonAceptar(){
            try{
                ...
                obj = mainUI.getControladorEmpleado().guardar(obj);
